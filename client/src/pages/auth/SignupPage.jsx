    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-[#111] border border-white/5 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
          ...
          <div className="absolute -top-24 -right-24 w-48 h-48 bg-purple-500/10 blur-[100px]" />
          <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-cyan-500/10 blur-[100px]" />
          ...
          <form onSubmit={handleSignup} className="space-y-4 relative z-10">
            <div>
              <label className="block text-[10px] font-mono uppercase tracking-widest text-gray-500 mb-2 ml-1">Full Name</label>
            ...
            <div>
              <label className="block text-[10px] font-mono uppercase tracking-widest text-gray-500 mb-2 ml-1">Confirm Password</label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-600" size={18} />
                <input 
          ...
          <div className="grid grid-cols-2 gap-4 relative z-10">
            <button className="bg-[#1a1a1a] hover:bg-[#222] border border-white/5 py-2.5 rounded-lg flex items-center justify-center gap-2 text-sm transition-colors text-gray-300">
          ...
          <p className="mt-8 text-center text-gray-500 text-sm">
            Already have an account? <Link to="/auth/login" className="text-cyan-400 cursor-pointer hover:underline">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
