    ...
    <nav className="w-full fixed top-0 z-50 bg-[#000000ec] border-b border-[rgba(255,255,255,0.06)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="text-white px-4 py-1.5 rounded-[6px] text-md tracking-wide font-semibold border border-white border-dashed hover:scale-105  transition-transform">
            Start Free →
          </button>
        </div>
      </div>
