...
export default function Footer() {
  return (
    <footer className="w-full bg-[#0a0a0a] border-t border-[rgba(255,255,255,0.08)] pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          ...
          <div className="flex flex-col gap-3">
            ...
            {['Features', 'Templates', 'How It Works', 'Pricing', 'Changelog'].map(link => (
          ...
          {/* Col 3 */}
          <div className="flex flex-col gap-3">
            <h4 className="font-mono text-xs font-bold text-white mb-2 uppercase tracking-wider">Company</h4>
            {['About', 'Blog', 'Privacy Policy', 'Terms of Service', 'Contact'].map(link => (
              <a key={link} href="#" className="font-sans text-sm text-muted hover:text-white transition-colors">{link}</a>
            ))}
          </div>
          ...
          <div className="flex flex-col gap-4">
            <h4 className="font-mono text-xs font-bold text-white mb-2 uppercase tracking-wider">Connect</h4>
            <div className="flex gap-4">
              ...
              <a href="#" className="text-muted hover:text-[#06b6d4] transition-colors">
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.84 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg>
              </a>
              <a href="#" className="text-muted hover:text-[#6366f1] transition-colors">
              ...
              <a href="#" className="text-muted hover:text-[#8b5cf6] transition-colors font-mono text-lg font-bold w-5 h-5 flex justify-center items-center leading-none">#</a>
            </div>
          </div>
        </div>
