...
const compileHTML = (userData, githubData, leetcodeData) => {
  ...
  <main class="w-full max-w-3xl mx-auto px-6 sm:px-8 py-10 space-y-16">
      ...
      <div class="flex flex-col md:flex-row gap-8 relative items-start">
        ...
        <div class="flex-1 space-y-4">
          ...
          <div class="flex items-center gap-5 pt-4 text-zinc-600 hover-icons">
            ...
            ${leetcodeUrl ? `
            <a href="${leetcodeUrl}" target="_blank" rel="noopener noreferrer" class="transition-all hover:scale-110 hover:text-amber-500 flex items-center justify-center" title="LeetCode">
              <img src="https://assets.leetcode.com/static_assets/public/images/LeetCode_logo_rvs.png" alt="LeetCode" class="w-7 h-7 object-contain">
            </a>` : ''}
            ${instagramUrl ? `
    ...
    ${stackItems.length > 0 ? `
    <section id="skills" class="w-full space-y-4 reveal animate-reveal">
    ...
    if (link.platform === 'github') {
      ...
      platformIcon = `<img src="https://assets.leetcode.com/static_assets/public/images/LeetCode_logo_rvs.png" alt="LeetCode" class="w-4 h-4 object-contain">`;
